...
void check_holding(bool *is_holding, uint32_t button_double_press_counting, uint32_t decimal_second_count,
			uint32_t holding_bound, uint32_t decimal_second_count, uint32_t button_holding_time,
